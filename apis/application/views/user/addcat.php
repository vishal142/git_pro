...
echo form_open('Category/addcat', $attributes); ?>
  
  <lable> Categoery Name</label> <input type="txt" name="catname" placeholder="Categoery name" onblur="check_cat()"> <span id="error_msg" style="color: red"></span> <br>
